$GPORevBlockedInheritance = [ordered] @{
    ...
    Execute        = {
        if ($Script:Reporting['GPOBlockedInheritance']['Exclusions']) {
            Get-GPORevInheritance -IncludeBlockedObjects -IncludeExcludedObjects -OnlyBlockedInheritance -IncludeGroupPoliciesForBlockedObjects -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $Excludeomains -Exclusions $Script:Reporting['GPOBlockedInheritance']['Exclusions']
        } else {
            Get-GPORevInheritance -IncludeBlockedObjects -IncludeExcludedObjects -OnlyBlockedInheritance -IncludeGroupPoliciesForBlockedObjects -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $Excludeomains
        }
    }
    Processing     = {
    ...
    Summary        = {
        ...
        if ($Script:Reporting['GPOBlockedInheritance']['Exclusions']) {
            ...
            $Code = New-GPORevExclusions -ExclusionsArray $Script:Reporting['GPOBlockedInheritance']['Exclusions']
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevBlockedGPOInheritanceBefore.html -Verbose -Type GPOBlockedInheritance
                                }
                                ...
                                New-HTMLCodeBlock -Code {
                                    $GPOOutput = Get-GPORevInheritance -IncludeBlockedObjects -IncludeExcludedObjects -OnlyBlockedInheritance
                            ...
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevBlockedGPOInheritanceAfter.html -Verbose -Type GPOBlockedInheritance
                                }
