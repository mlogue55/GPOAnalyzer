$GPORevDuplicates = [ordered] @{
    Name       = 'Duplicate (CNF) Group Policies'
    Enabled    = $true
    Action     = $null
    Data       = $null
    Execute    = {
        Get-GPORevDuplicateObject -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
    }
    Processing = {
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevDuplicateObjectsBefore.html -Verbose -Type GPODuplicates
                                }
                                ...
                                New-HTMLCodeBlock -Code {
                                    $GPOOutput = Get-GPORevDuplicateObject
                            ...
                            New-HTMLWizardStep -Name 'Remove CNF objects' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Remove-GPORevDuplicateObject -WhatIf -Verbose
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Remove-GPORevDuplicateObject -Verbose -LimitProcessing 2
                                }
                                New-HTMLText -TextBlock {
                            ...
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevDuplicateObjectsAfter.html -Verbose -Type GPODuplicates
                                }
