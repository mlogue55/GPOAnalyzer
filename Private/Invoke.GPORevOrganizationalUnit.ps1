$GPORevOrganizationalUnit = [ordered] @{
    ...
    Execute        = {
        if ($Script:Reporting['GPOOrganizationalUnit']['Exclusions']) {
            Get-GPORevOrganizationalUnit -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains -ExcludeOrganizationalUnit $Script:Reporting['GPOOrganizationalUnit']['Exclusions']
        } else {
            Get-GPORevOrganizationalUnit -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
        }
    }
    Processing     = {
    ...
    Summary        = {
        ...
        if ($Script:Reporting['GPOOrganizationalUnit']['Exclusions']) {
            ...
            $Code = New-GPORevExclusions -ExclusionsArray $Script:Reporting['GPOOrganizationalUnit']['Exclusions']
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        ...
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevGPOOrganizationalUnitBefore.html -Verbose -Type GPOOrganizationalUnit
                                }
                                ...
                                New-HTMLCodeBlock -Code {
                                    $OwnersGPO = Get-GPORevOrganizationalUnit -Verbose
                            ...
                            New-HTMLWizardStep -Name 'Unlink unused Group Policies' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Remove-GPORevLinkEmptyOU -WhatIf -Verbose
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Remove-GPORevLinkEmptyOU -WhatIf -Verbose -IncludeDomains 'YourDomainYouHavePermissionsFor'
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Remove-GPORevLinkEmptyOU -WhatIf -LimitProcessing 2 -Verbose
                                }
                                New-HTMLText -TextBlock {
                                    "Alternatively for multi-domain scenario, if you have limited Domain Admin credentials to a single domain please use following command: "
                                }
                                New-HTMLCodeBlock -Code {
                                    Remove-GPORevLinkEmptyOU -WhatIf -LimitProcessing 2 -Verbose -IncludeDomains 'YourDomainYouHavePermissionsFor'
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    ...
                                    Remove-GPORevLinkEmptyOU -Verbose -LimitProcessing 3 -WhatIf -ExcludeOrganizationalUnit $Exclude
                                }
                            }
                            ...
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevGPOOrganizationalUnitAfter.html -Verbose -Type GPOOrganizationalUnit
                                }
