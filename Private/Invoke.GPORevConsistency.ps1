$GPORevConsistency = [ordered] @{
    Name           = 'GPO Permissions Consistency'
    Enabled        = $true
    ActionRequired = $null
    Data           = $null
    Execute        = {
        Get-GPORevPermissionConsistency -Type All -VerifyInheritance -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
    }
    Processing     = {
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        ...
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevPermissionsInconsistentBefore.html -Verbose -Type GPOConsistency
                                }
                                New-HTMLText -Text @(
                                ...
                                New-HTMLCodeBlock -Code {
                                    $GPOOutput = Get-GPORevPermissionConsistency
                            ...
                            New-HTMLWizardStep -Name 'Fix inconsistent permissions' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Repair-GPORevPermissionConsistency -IncludeDomains "TargetDomain" -Verbose -WhatIf
                                }
                                ...
                                New-HTMLCodeBlock -Code {
                                    Repair-GPORevPermissionConsistency -LimitProcessing 2 -IncludeDomains "TargetDomain"
                                }
                                New-HTMLText -TextBlock {
                            ...
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevPermissionsInconsistentAfter.html -Verbose -Type GPOConsistency
                                }
