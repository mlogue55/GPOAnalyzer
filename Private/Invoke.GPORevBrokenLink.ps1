$GPORevBrokenLink = [ordered] @{
    Name           = 'Group Policy Broken Links'
    Enabled        = $true
    ActionRequired = $null
    Data           = $null
    Execute        = {
        Get-GPORevBrokenLink -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
    }
    Processing     = {
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevBrokenLinkBefore.html -Verbose -Type GPOBrokenLink
                                }
                                ...
                                New-HTMLCodeBlock -Code {
                                    $GPOOutput = Get-GPORevBrokenLink -Verbose
                            ...
                            New-HTMLWizardStep -Name 'Remove Broken Links' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Repair-GPORevBrokenLink -WhatIf -Verbose
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Repair-GPORevBrokenLink -Verbose -LimitProcessing 2
                                }
                                New-HTMLText -TextBlock {
                            ...
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevBrokenLinkAfter.html -Verbose -Type GPOBrokenLink
                                }
