$GPORevNetLogonOwners = [ordered] @{
    Name           = 'NetLogon Owners'
    Enabled        = $true
    ActionRequired = $null
    Data           = $null
    Execute        = {
        Get-GPORevNetLogon -OwnerOnly -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
    }
    Processing     = {
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevNetLogonBefore.html -Verbose -Type NetLogonOwners
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    $NetLogonOutput = Get-GPORevNetLogon -OwnerOnly -Verbose
                            ...
                            New-HTMLWizardStep -Name 'Set non-compliant file owners to BUILTIN\Administrators' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Repair-GPORevNetLogonOwner -Verbose -WhatIf
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Repair-GPORevNetLogonOwner -Verbose -WhatIf -IncludeDomains 'YourDomainYouHavePermissionsFor'
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Repair-GPORevNetLogonOwner -Verbose -LimitProcessing 2
                                }
                                New-HTMLText -TextBlock {
                                    "Alternatively for multi-domain scenario, if you have limited Domain Admin credentials to a single domain please use following command: "
                                }
                                New-HTMLCodeBlock -Code {
                                    Repair-GPORevNetLogonOwner -Verbose -LimitProcessing 2 -IncludeDomains 'YourDomainYouHavePermissionsFor'
                                }
                            }
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevNetLogonAfter.html -Verbose -Type NetLogonOwners
                                }
