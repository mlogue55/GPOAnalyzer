$GPORevPermissionsUnknown = [ordered] @{
    Name       = 'Group Policy Unknown Permissions'
    Enabled    = $false
    Action     = $null
    Data       = $null
    Execute    = {
        Get-GPORevPermission -Type Unknown -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
    }
    Processing = {
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevGPOPermissionsUnknownBefore.html -Verbose -Type GPOPermissionsUnknown
                                }
                                ...
                                New-HTMLCodeBlock -Code {
                                    $UnknownPermissions = Get-GPORevPermission -Type Unknown
                            ...
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevGPOPermissionsUnknownAfter.html -Verbose -Type GPOPermissionsUnknown
                                }
