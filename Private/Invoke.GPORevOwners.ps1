$GPORevOwners = [ordered] @{
    ...
    Execute        = {
        if ($Script:Reporting['GPOOwners']['Exclusions']) {
            Get-GPORevOwner -IncludeSysvol -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains -ApprovedOwner $Script:Reporting['GPOOwners']['Exclusions']
        } else {
            Get-GPORevOwner -IncludeSysvol -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
        }
    }
    Processing     = {
    ...
    Summary        = {
        ...
        if ($Script:Reporting['GPOOwners']['Exclusions']) {
            ...
            $Code = New-GPORevExclusions -ExclusionsArray $Script:Reporting['GPOOwners']['Exclusions']
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        ...
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevGPOOwnersBefore.html -Verbose -Type GPOOwners
                                }
                                ...
                                New-HTMLCodeBlock -Code {
                                    $OwnersGPO = Get-GPORevOwner -IncludeSysvol -Verbose
                            ...
                            New-HTMLWizardStep -Name 'Set GPO Owners to Administrative (Domain Admins)' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Set-GPORevOwner -Type All -Verbose -WhatIf
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Set-GPORevOwner -Type All -Verbose -WhatIf -IncludeDomains 'YourDomainYouHavePermissionsFor'
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Set-GPORevOwner -Type All -Verbose -LimitProcessing 2
                                }
                                New-HTMLText -TextBlock {
                                    "Alternatively for multi-domain scenario, if you have limited Domain Admin credentials to a single domain please use following command: "
                                }
                                New-HTMLCodeBlock -Code {
                                    Set-GPORevOwner -Type All -Verbose -LimitProcessing 2 -IncludeDomains 'YourDomainYouHavePermissionsFor'
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    ...
                                    Set-GPORevOwner -Type All -Verbose -LimitProcessing 2 -ApprovedOwner $Approved
                                }
                                New-HTMLText -TextBlock {
                            ...
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevGPOOwnersAfter.html -Verbose -Type GPOOwners
                                }
