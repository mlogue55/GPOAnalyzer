$GPORevPermissionsRead = [ordered] @{
    ...
    Execute    = {
        [ordered] @{
            Permissions = Get-GPORevPermission -Type AuthenticatedUsers -ReturnSecurityWhenNoData -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
            Issues      = Get-GPORevPermissionIssue -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains
        }
    }
    Processing = {
                    ...
                    New-HTMLSpanStyle -FontSize 10pt {
                        New-HTMLWizard {
                            ...
                            New-HTMLWizardStep -Name 'Prepare report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevGPOPermissionsReadBefore.html -Verbose -Type GPOPermissionsRead
                                }
                                New-HTMLText -TextBlock {
                                ...
                                New-HTMLCodeBlock -Code {
                                    $AuthenticatedUsers = Get-GPORevPermission -Type AuthenticatedUsers -ReturnSecurityWhenNoData
                            ...
                            New-HTMLWizardStep -Name 'Verification report' {
                                ...
                                New-HTMLCodeBlock -Code {
                                    Invoke-GPORev -FilePath $Env:UserProfile\Desktop\GPORevGPOPermissionsReadAfter.html -Verbose -Type GPOPermissionsRead
                                }
