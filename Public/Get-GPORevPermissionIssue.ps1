function Get-GPORevPermissionIssue {
    <#
    .SYNOPSIS
    ...
    foreach ($Domain in $ForestInformation.Domains) {
        ...
        Write-Verbose "Get-GPORevPermissionIssue - Starting process for $Domain"
        ...
        Write-Verbose "Get-GPORevPermissionIssue - Finishing process for $Domain (Time to process: $TimeEnd)"
    }
}