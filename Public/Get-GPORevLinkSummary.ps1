function Get-GPORevLinkSummary {
    [cmdletBinding()]
    param(
    ...
    # Get all links
    $Links = Get-GPORevLink -Forest $Forest -IncludeDomains $IncludeDomains -ExcludeDomains $ExcludeDomains -ExtendedForestInformation $ExtendedForestInformation -Linked Root, DomainControllers, OrganizationalUnit
